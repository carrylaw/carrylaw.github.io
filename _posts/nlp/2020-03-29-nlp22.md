...
**7.-spec-、-spic-、-spect-看**    
special特别的（特别好看的）、especially特别的（出去来特别好看的）、specific具体的（看的很具体的）、species种类、specimen样品、aspect方面（靠近看一方面）       
specious体面的（可以看的）、conspecious显眼的（共同体面的）、perspective透视（透过去看）       

### <span style="color:#008B8B;">· E词：出去、向外</span>    
1.比较级、最高级（出去、向外）        
...
extend扩展/延伸、extent范围、to...extent在...程度上、extensive广泛的、extension延伸
expend花费（spend花费，把钱花出去）、expendable可花费的、expense花费、expensive昂贵的（花了很多钱）       
...
exclude排除（关在房间外）、exclusive排除（放在外面的）、include包括（关在房间里）、seclude隐居/隔离（分开之后关起来）、close关闭                 
excavate挖掘（向外cave山洞，挖出来一个山洞）、excavator挖掘机        
exceed超越（走出去了）、proceed向前走、exceedingly尤其/特别的、especially特别地     
excess超过/过量、excessive多余的（超过太多了）       
exclaim呼喊（向外claim喊出来的）
exhaust耗尽（haust消耗，都耗出来了）、expel开除（放到外面去）        
exhale呼出/呼气（向外hale精神矍铄的呼气）、expire到期/死亡（把spire气吐出去了）、inspire吸气（把气往里吸入）/产生灵感/鼓励、encourage鼓励、inspiration灵感                 
external外部的、internal内部的、exterior外部的、interior内部的       
extract提取（tractor拖拉机、tract拉扯，拉扯出来）、extractor抽油烟机        
3.en-、em-用力（产生力量）                 
（1）en-用力       
...
endure忍受（使during度过一段时间）、stand忍受、temper脾气        
...
### <span style="color:#008B8B;">· Z词：之，表示曲折</span>    
zigzag曲折的、go zigzag走之字形（形容喝酒后东倒西歪）、why are you still zigzaging？为何你仍然徘徊犹豫不定？       
zombie僵尸（东倒西歪着走）       
zoo动物园（动物园的路曲折的）、zebra斑马（斑马身上的图案曲折）       
zest热情/激情、zeal热情/激情、zealous激情的（例如背单词的激情，上上下下曲曲折折）       
