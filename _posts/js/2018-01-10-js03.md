...
category: fjs
---
接下来我们再来试着做一个多层嵌套饼图，单层饼图能够反映各类数据之间的比例关系，但日常业务中往往会遇到每个类别中再嵌套多个类别的情况，因此我们需要借助多层嵌套饼图来进行展示

<div align="center">
<img width="90%" src="https://raw.githubusercontent.com/carrylaw/IMG/master/img_js/js07.png" /> 
</div> 

上图是Echarts官网原始的[多层嵌套饼图](http://gallery.echartsjs.com/editor.html?c=xB14W3PDJW)，下图是修改后的嵌套饼图
